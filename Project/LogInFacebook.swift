...
class LogInFacebook: BaseMenuController, FBSDKLoginButtonDelegate, GIDSignInUIDelegate {
...
//        loginFacebookButton.titleLabel?.font = UIFont.boldSystemFont(ofSize: 16)
        ...
        customFacebookButton.frame = CGRect(x: 40, y: 100, width: view.frame.width - 80, height: 50)
