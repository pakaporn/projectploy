...
class MyMenuScre: UITableViewController , UISearchBarDelegate, UITextViewDelegate {
...
//                print(user?.displayName)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "StoryMy Cell", for: indexPath) as! MyMenuScreCell
