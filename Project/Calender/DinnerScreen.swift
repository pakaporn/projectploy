...
class DinnerScreen: UITableViewController, UISearchBarDelegate, UITextViewDelegate {
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Dinner Cell", for: indexPath) as! DinnerCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let iden = "DinnerDetail"
        if segue.identifier == iden {
            let myMenuDetail = segue.destination as! DinnerDetail
