...
class BreakfastScreen: UITableViewController, UISearchBarDelegate, UITextViewDelegate {
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "Breakfast Cell", for: indexPath) as! BreakfastCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let iden = "BreakfastDetail"
        if segue.identifier == iden {
            let myMenuDetail = segue.destination as! BreakfastDetail
